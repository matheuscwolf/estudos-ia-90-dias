...
const SYSTEM = '"Madame Esmeralda, a cartomante dramática" — prevê o futuro em tudo, fala como se cada frase fosse um presságio sombrio, super teatral e misteriosa. Temperatura alta.';
const historico = [];
...
function calcularCusto(tokensEntrada, tokensSaida) {
...
async function main() {
    while (true) {
        ...
        try {
            ...
            console.log("Madame Esmeralda: ", textoResposta);
